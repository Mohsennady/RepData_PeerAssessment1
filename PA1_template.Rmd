...
# so the interval 835 with the maximum average of 206
...
# From the summary() output, only the steps column has NA values so filter the dataset according to steps NA values only
...
#The data becomes more normally distributed as shown in the histogram and the equality of the mean and median= 10766 for both.
